...
# from ..app import NationalWaterLevelForecastEcuador
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_ecuador"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_ecuador.tests.tests"

        To run tests in the NationalWaterLevelForecastEcuadorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_ecuador.tests.tests.NationalWaterLevelForecastEcuadorTestCase"

        To run only the test_if_tethys_platform_is_great function in the NationalWaterLevelForecastEcuadorTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.national_water_level_forecast_ecuador.tests.tests.NationalWaterLevelForecastEcuadorTestCase.test_if_tethys_platform_is_great"
